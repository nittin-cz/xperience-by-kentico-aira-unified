            ...
            <div class="container">
                ...
                <template v-if="phase == 'empty'">
                    <div class="c-empty-page-layout">
                        ...
                        <div>
                            <img :src="`${this.baseUrl}/_content/Kentico.Xperience.AiraUnified/img/image-placeholder.svg`"
                                ...
                                <div class="c-uploaded-image">
                                    <div class="c-uploaded-image_header">
                                        <button aria-label="Remove" class="btn btn-remove-img" @click="removeFile2(file, index);">
                                            <img :src="`${this.baseUrl}/_content/Kentico.Xperience.AiraUnified/img/icons/cross.svg`"
                                                alt="" class="c-icon"/>
                                        </button>
                                    </div>
                    ...
                    <div v-if="!alertHidden" class="c-alert mt-3" role="alert">
                        ...
                        <div class="c-alert_footer">
                            <button aria-label="Remove" class="btn btn-remove-img"
                                ...
                                <img
                                    :src="`${this.baseUrl}/_content/Kentico.Xperience.AiraUnified/img/icons/cross.svg`"
                                    alt="" class="c-icon"/>
                            </button>
                        </div>
                    </div>
    ...
    methods: {
        main() {
            ...
            showUnsuccessfulAlert(message)
            {
                ...
                this.alertResultIconUrl = `${this.baseUrl}/_content/Kentico.Xperience.AiraUnified/img/icons/cross-red.svg`;
                this.alertHidden = false;
            },
            showSuccessfulAlert()
            {
                this.uploadResultMessage = this.uploadSuccessfulMessage;
                this.alertResultIconUrl = `${this.baseUrl}/_content/Kentico.Xperience.AiraUnified/img/icons/check-circle-green.svg`;
                this.alertHidden = false;
            },
            async fireUpload() {
