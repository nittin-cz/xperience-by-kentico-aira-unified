<template>
    <div class="c-app_inner" v-bind:class="{'is-loaded':isLoaded}">
        ...
        <div class="c-app_body" :style="{ maxHeight: '60vh', overflowY: 'auto', overflowX: 'hidden' }">
            <div>
                <a href="#" class="c-thread" v-for="i in [1,2,3]" :key="'thread-' + i" :class="{'unread' : i == 2}">
                    <span class="d-block c-thread_icon">
                        ...
                        <span class="c-thread_header">
                            <span class="c-thread_title">AIRA</span>
                            <span class="c-thread_indicator"></span>
                            <span class="c-thread_time"> 15 min ago</span>
                        </span>
                        <span class="c-thread_content">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium cum deserunt ea eum praesentium veritatis vero. Nam neque nesciunt reiciendis.
                        </span>
                    </span>
                </a>
                <div class="d-flex justify-content-end mt-2">
                    <button class="btn btn-link secondary">
